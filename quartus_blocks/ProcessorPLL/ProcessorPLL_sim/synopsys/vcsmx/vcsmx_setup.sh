...
# ACDS 21.1 842 linux 2023.06.23.17:48:23
...
# ----------------------------------------
# If ProcessorPLL is one of several IP cores in your
...
TOP_LEVEL_NAME="ProcessorPLL"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/home/allan/Programs/intelFPGA_lite/21.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ProcessorPLL.vho"
fi
